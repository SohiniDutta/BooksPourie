            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <?php echo form_open('products/add-brand',['role' => 'form']); ?>
                        <div class="card-body">
                            <?php 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="brand_name" placeholder="Enter brand name" value="<?php echo set_value('brand_name'); ?>" autocomplete="off"/>
